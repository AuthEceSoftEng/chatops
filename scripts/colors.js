// for color and color name match: https://www.w3schools.com/colors/colors_names.asp
module.exports = {
    getHex: function (color) {
        ...
        var colors = {
            ...
            darkcyan: '#008b8b', darkgoldenrod: '#b8860b', darkgray: '#a9a9a9', darkgrey: '#a9a9a9', darkgreen: '#006400',
        ...
        if (!color || typeof colors[color.toLowerCase()] == 'undefined') {
            // get a random color
            var tags = Object.keys(colors)
            var colorName = tags[Math.floor(Math.random() * tags.length) + 0]
